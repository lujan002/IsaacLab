...
gym.register(
    id="Isaac-Lift-Cube-ArticulatedArmRev2-v0",
...
gym.register(
    id="Isaac-Lift-Cube-ArticulatedArmRev2-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Cube-ArticulatedArmRev2-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Teddy-Bear-ArticulatedArmRev2-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Cube-ArticulatedArmRev2-IK-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
