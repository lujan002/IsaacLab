...
class FrankaCubeLiftEnvCfg(joint_pos_env_cfg.FrankaCubeLiftEnvCfg):
    def __post_init__(self):
        ...
        # EE contact reward uses Articulated Arm link names; disable for Franka IK.
        self.scene.ee_object_contact = None
        self.rewards.ee_object_contact = None
        self.rewards.gripper_midrange_open = None
